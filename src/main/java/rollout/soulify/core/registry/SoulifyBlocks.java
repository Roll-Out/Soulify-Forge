...
public class SoulifyBlocks {
	...
	public static final RegistryObject<Block> SOUL_PUMPKIN = HELPER.createSimpleBlock("soul_pumpkin", () -> new SoulPumpkinBlock(Block.Properties.from(Blocks.PUMPKIN)), ItemGroup.DECORATIONS);
	public static final RegistryObject<Block> CARVED_SOUL_PUMPKIN = HELPER.createSimpleBlock("carved_soul_pumpkin", () -> new CarvedSoulPumpkinBlock(Block.Properties.from(Blocks.CARVED_PUMPKIN)), ItemGroup.DECORATIONS);
	public static final RegistryObject<Block> SOUL_JACK_O_LANTERN = HELPER.createSimpleBlock("soul_jack_o_lantern", () -> new CarvedSoulPumpkinBlock(Block.Properties.from(Blocks.JACK_O_LANTERN).setLightLevel((a) -> {return 10;})), ItemGroup.DECORATIONS);
